...
from typing import Any, Text, Dict, List # Tipagem para facilitar a leitura de código
from rasa_sdk import Action, Tracker # Importação de classes para criar a custom action
from rasa_sdk.executor import CollectingDispatcher # Classe que permite enviar respostas ao usúario
...
class ActionInformaClima(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        print(f"City: {city}")
        print(f"Wather Data: {weather_data}")
    ...
    def get_weather(self, city: str) -> Dict[Text, Any]:
        ...
        api_key="ea977591ce3c478ea3f223939252503" # Chave da API
        base_url = "http://api.weatherapi.com/v1/current.json"
        params = {
            "q": city,  # Parâmetro da cidade a ser consultada
            "aqi": "no", # Não incluir dados de qualidade do ar
            "key": api_key # Xhave de acesso a API
        }

        try:
            # Faz a requisiao GET para a API
